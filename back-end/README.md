# [Loose touch back-end](http://www.loosetouch.com)


# loose-touch serverless API
The loose-touch project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
...
```bash
$ mvn archetype:generate -DartifactId=loose-touch -DarchetypeGroupId=com.amazonaws.serverless.archetypes -DarchetypeArtifactId=aws-serverless-springboot2-archetype -DarchetypeVersion=1.3 -DgroupId=com.oakinvest.lt -Dversion=1.0-SNAPSHOT -Dinteractive=false
$ cd loose-touch
$ mvn clean package
            ...
            "Outputs": [
                {
                    ...
                    "ExportName": "LooseTouchApi",
                    "OutputKey": "LooseTouchApi",
