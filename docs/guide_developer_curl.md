...
## Define loose touch token for account 1.
```
...
```
curl "${LOOSE_TOUCH_SERVER_URL}/v1/account/profile" -H "Authorization: Bearer ${LOOSE_TOUCH_ID_TOKEN_FOR_USER_1}" -X GET -s | jq
```
